...
const posts: BlogPost[] = postModules.keys().map((key) => {
  const rawContent = postModules(key).default;
  const parsed = frontMatter.default(rawContent);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/solutions" className="text-peach hover:text-mint transition-colors">Solutions</Link></li>
              <li><Link href="/blog" className="text-peach hover:text-mint transition-colors">Blog</Link></li>
              <li><Link href="/faq" className="text-peach hover:text-mint transition-colors">FAQ</Link></li>
              <li><Link href="/about" className="text-peach hover:text-mint transition-colors">About Us</Link></li>
              <li><Link href="/locations" className="text-peach hover:text-mint transition-colors">Prospective Locations</Link></li>
              <li><Link href="/service-area" className="text-peach hover:text-mint transition-colors">Service Area</Link></li>
              <li><Link href="/contact" className="text-peach hover:text-mint transition-colors">Contact</Link></li>
            </ul>
          </div>
