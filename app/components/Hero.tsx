          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="lg:w-1/2 text-center lg:text-left">
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 text-mint leading-tight">
                Your Partner in Crafting the Perfect <span style={{color: '#FF8E7F'}}>Breakroom Experience</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mx-0 px-0">
                <Link href="/contact" className="bg-gradient-pastel text-navy px-8 py-3 rounded-full font-semibold hover:shadow-neon transition-all flex items-center justify-center gap-2 group">
                  Get Started <ArrowRight className="group-hover:translate-x-1 transition-transform" size={18} />
                </Link>
                <Link href="/solutions" className="border-2 border-mint text-mint px-8 py-3 rounded-full hover:bg-mint/10 transition-all">
                  Explore Solutions
                </Link>
              </div>
            </div>
            ...
            <div className="lg:w-1/2 flex justify-center lg:justify-end">
              <Image
                ...
                alt="Smart Market Retail Vending Machine"
                width={500}
                height={500}
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <Link href="/solutions" className="border-2 border-mint text-mint px-8 py-3 rounded-full hover:bg-mint/10 transition-all text-center">
                  Explore Solutions
                </Link>
              </div>
            </div>
